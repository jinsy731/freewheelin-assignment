...
data class PieceProblemOrder(
    ...
    companion object {
         ...
         * 빈 컬렉션 생성
         */
        fun empty(): PieceProblemOrder = PieceProblemOrder(emptyList())
        
        /**
         * 단일 문제로 컬렉션 생성
         */
        fun of(problem: PieceProblem): PieceProblemOrder = PieceProblemOrder(listOf(problem))
        
        /**
         * 여러 문제로 컬렉션 생성
         */
        fun of(problems: List<PieceProblem>): PieceProblemOrder = PieceProblemOrder(problems)
    }
} 